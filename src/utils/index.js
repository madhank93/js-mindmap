...
export function generateSimpleModel() {
    ...
    return Model.create({
        ...
        "focusKey": "a3a421e7-3427-489e-892c-2342014a2235",
        "extData": {
            "TOPIC_REFERENCE": {
                "reference": {
        ...
        "topics": [
            ...
            },
            {
                ...
                "parentKey": "89cf71a0-0ca8-45ff-b136-62ffbf6ff778",
                "subKeys": [
                    "73667249-cfd7-438c-a8db-cb40b58d16fb"
                ],
                "collapse": true,
                "style": null,
                "blocks": [
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "DESC",
                        "data": "A promise is a JavaScript object that will return a value at some point in the future. A pending promise can either be fulfilled with a value or rejected with a reason \\(error\\).\n\nFetch API, a provides a standard way to make server requests with promises.\n\n* promise fulfilled flow\n\n```\nfetch('https://api.github.com/users/octocat')\n    .then((response) => {\n        return response.json()\n    })\n    .then((data) => {\n        console.log(data)\n    })\n    .catch((error) => {\n        console.error(error)\n    })\n\n```\n\n* promise error flow\n\n```\nfetch('https://api.github.com/users/!@#$%')\n    .then((response) => {\n        return response.json()\n    })\n    .then((data) => {\n        console.log(data)\n    })\n    .catch((error) => {\n        console.error(error)\n    })\n\n```\n"
                    }
                ]
            },
            {
